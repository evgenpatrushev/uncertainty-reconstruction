...
class TSDFVolume:
  ...
  """
  def __init__(self, vol_bnds, voxel_size, trunc=3, use_gpu=True):
    """Constructor.
    ...
    self._trunc_margin = trunc * self._voxel_size  # truncation on SDF
  ...
  def integrate(self, color_im, depth_im, cam_intr, cam_pose, obs_weight=1.):
    ...
    if self.gpu_mode:  # GPU mode: integrate voxel volume (calls CUDA kernel)
      ...
      # dist = np.minimum(self._trunc_margin/self._voxel_size, depth_diff / self._voxel_size)
